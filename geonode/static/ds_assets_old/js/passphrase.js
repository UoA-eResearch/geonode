...
// genpass
    console.log("Inside initialiseArray() gets called: ");
    words = [
...
function populateform(enterlength) {
    ...
    //entropyOutput.textContent = password.entropy.toFixed(2);    
    //04June2022 ..enable the 'Download encrypted File button'
    console.log('going to enable')
    //document.getElementById("downloadEncryptedOriginal").enabled = true;
    //document.getElementById("upload-geonode-button").enabled = true;
    console.log('enabled')
}
