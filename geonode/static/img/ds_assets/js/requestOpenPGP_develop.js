...
{    
  ...
  var binaryData = new Uint8Array(await zipBlob.arrayBuffer()); //new Uint8Array(zipBlob);  
  ...
  const { data: decrypted } = await openpgp.decrypt({
    message: await openpgp.readMessage({ binaryMessage: encrypted  }),  //binaryData    //({ text: 'Hello, World!' }), // input as Message object
