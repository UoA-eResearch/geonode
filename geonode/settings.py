...
try:
    ...
    ALLOWED_DOCUMENT_TYPES = [
        ...
        'fli', 'mp2', 'mp4', 'mpg', 'ogg', 'webm', '3gp', 'flv', 'vdo', 'enc', 'json' , 'geojson'
...
# /home/ubuntu/my_geonode/djangoerror.log
LOGGING = {
    'version': 1,
...
DISPLAY_VERIFICATION = ast.literal_eval(os.getenv('DISPLAY_VERIFICATION', 'True'))
